        ...
        <section className="bg-white p-6 rounded-xl shadow space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <FieldInput
              label="MBL Number"
              name="mblNumber"
              defaultValue={job.mblNumber || ""}
            />
            <FieldInput
              label="MBL Date"
              name="mblDate"
              type="date"
              defaultValue={fmtDate(job.mblDate)}
            />
            <FieldInput
              label="HBL Number"
              name="hblNumber"
              defaultValue={job.hblNumber || ""}
            />
            <FieldInput
              label="HBL Date"
              name="hblDate"
              type="date"
              defaultValue={fmtDate(job.hblDate)}
            />
          </div>
        </section>
        ...
        <section className="bg-white p-6 rounded-xl shadow space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <FieldInput
              ...
              name="portOfLoading"
              defaultValue={job.portOfLoading || ""}
            />
            <FieldInput
              label="Port of Discharge"
              name="portOfDischarge"
              defaultValue={job.portOfDischarge || ""}
            />
            <FieldInput
              label="Clearance At"
              name="clearanceAt"
              defaultValue={job.clearanceAt || ""}
            />
          </div>
        </section>
        ...
        <section className="bg-white p-6 rounded-xl shadow space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <FieldInput
              label="Consignee"
              name="consignee"
              defaultValue={job.consignee || ""}
            />
            <FieldInput
              label="Shipper"
              name="shipper"
              defaultValue={job.shipper || ""}
            />
          </div>
        </section>
        ...
        <section className="bg-white p-6 rounded-xl shadow space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <FieldInput
              label="PKGS"
              name="pkgs"
              defaultValue={job.pkgs || ""}
            />
            <FieldInput
              label="Gross Weight"
              name="grossWeight"
              defaultValue={job.grossWeight || ""}
            />
        ...
        <section className="bg-white p-6 rounded-xl shadow space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <FieldInput
              label="BE Number"
              name="beNumber"
              defaultValue={job.beNumber || ""}
            />
            <FieldInput
              label="BE Date"
              name="beDate"
              type="date"
              defaultValue={fmtDate(job.beDate)}
            />
            <FieldInput
              label="Assessable Value"
              name="assessableValue"
              defaultValue={job.assessableValue || ""}
            />
            <FieldInput
            ...
            <FieldInput
              label="GIGAM Number"
              name="gigamNumber"
              defaultValue={job.gigamNumber || ""}
            />
            <FieldInput
              label="GIGAM Date"
              name="gigamDate"
              type="date"
              defaultValue={fmtDate(job.gigamDate)}
            />
            <FieldInput
              label="LIGN Number"
              name="lignNumber"
              defaultValue={job.lignNumber || ""}
            />
            <FieldInput
              label="LIGN Date"
              name="lignDate"
              type="date"
              defaultValue={fmtDate(job.lignDate)}
            />
          </div>
        </section>
        ...
        <section className="bg-white p-6 rounded-xl shadow space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <FieldInput
              ...
              defaultValue={job.containerNumber || ""}
            />
            <FieldInput
              label="Container Type"
              name="containerType"
              defaultValue={job.containerType || ""}
            />
          </div>
          <FieldInput
            label="Commodity"
            name="commodity"
            defaultValue={job.commodity || ""}
          />
        </section>
